...
if Rails.env.development?
  ...
  user_2.teams << team
  Profile.create(first_name: 'Test', last_name: 'User', job_title: 'Normal User', phone: '1234567890', user: user_1)
  Profile.create(first_name: 'Test', last_name: 'Admin', job_title: 'Admin User', phone: '1234567890', user: user_2)
  ...
  Profile.create(first_name: 'Robert', last_name: 'Narley', job_title: 'Owner', phone: '8008675309', user: client_1_contact_1)
  ...
  Profile.create(first_name: 'Sandy', last_name: 'Narley', job_title: 'Vice President', phone: '8008675310', user: client_1_contact_2)
  ...
  Profile.create(first_name: 'Bill', last_name: 'Lumbergh', job_title: 'Manager', phone: '8001234567', user: client_2_contact_1)
  ...
  Profile.create(first_name: 'Petter', last_name: 'Gibbons', job_title: 'Executive', phone: '8001234568', user: client_2_contact_2)
  ...
  Profile.create(first_name: 'Michael', last_name: 'Bolton', job_title: 'Executive', phone: '8001234569', user: client_2_contact_3)
  ...
  Profile.create(first_name: 'Samir', last_name: 'Nagheenanajar', job_title: 'Executive', phone: '8001234570', user: client_2_contact_4)
  ...
  Profile.create(first_name: 'Elon', last_name: 'Musk', job_title: 'Certified Bad Ass', phone: '1112223333', user: client_3_contact_1)
  ...
  Profile.create(first_name: 'Steve', last_name: 'Jobs', job_title: 'Money Maker', phone: '2223334444', user: client_3_contact_2)
