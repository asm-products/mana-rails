...
if Rails.env.development?
  ...
  client_1 = Client.create(name: 'Cool Stuff Inc.', address: '9000 Coolio Dr. San Antonio, Texas 78238 United States', phone: '8008675309', website: 'www.cool.com', short_code:'COOL')
  client_2 = Client.create(name: 'Cooperate Cooperation', address: '90210 Bevelry Blvd. San Antonio, Texas 78238 United States', phone: '8002221111', website: 'www.corp.com', short_code: 'CORP')
  client_3 = Client.create(name: 'Startups Inc.', address: '800 Somewhere Dr. Cupertino, California 95014 United States', phone: '1234567890', website: 'www.startup.com', short_code: 'STAR')
  ...
  client_2_contact_1 = User.create(name: 'thelumbergh', email: 'bill.lumbergh@corp.com', password: 'password', password_confirmation: 'password', client: client_2)
  UserProfile.create(first_name: 'Bill', last_name: 'Lumbergh', job_title: 'Manager', phone: '8001234567', user: client_2_contact_1)
  client_2_contact_2 = User.create(name: 'ihatemyjob', email: 'peter.gibbons@corp.com', password: 'password', password_confirmation: 'password', client: client_2)
  UserProfile.create(first_name: 'Petter', last_name: 'Gibbons', job_title: 'Executive', phone: '8001234568', user: client_2_contact_2)
  client_2_contact_3 = User.create(name: 'iwasboltonfirst', email: 'michael.bolton@corp.com', password: 'password', password_confirmation: 'password', client: client_2)
  UserProfile.create(first_name: 'Michael', last_name: 'Bolton', job_title: 'Executive', phone: '8001234569', user: client_2_contact_3)
  client_2_contact_4 = User.create(name: 'backupinthatass', email: 'samir.nagheenanajar@corp.com', password: 'password', password_confirmation: 'password', client: client_2)
  UserProfile.create(first_name: 'Samir', last_name: 'Nagheenanajar', job_title: 'Executive', phone: '8001234570', user: client_2_contact_4)
  client_3_contact_1 = User.create(name: 'istartedpaypal', email: 'elon@start.com', password: 'password', password_confirmation: 'password', client: client_3)
  UserProfile.create(first_name: 'Elon', last_name: 'Musk', job_title: 'Certified Bad Ass', phone: '1112223333', user: client_3_contact_1)
  client_3_contact_2 = User.create(name: 'thejobs', email: 'steve@start.com', password: 'password', password_confirmation: 'password', client: client_3)
